...
//             var deeperValues = findVals(object[k], key);
//             if(deeperValues.length){
//                 values = [...values, ...deeperValues]
//             }
...
//     //fs.writeFileSync(path.join(projectFolderName, "aiwilldo.json"), JSON.stringify({aiwilldo: findVals(baseGame, "ai_will_do")}, null, 2));
